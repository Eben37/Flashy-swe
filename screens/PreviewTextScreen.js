...
import { StyleSheet, View, Text, ScrollView, TextInput, TouchableOpacity, Modal, ActivityIndicator, SafeAreaView, KeyboardAvoidingView, Platform } from 'react-native';
...
const PreviewTextScreen = ({ route }) => {
    const navigation = useNavigation();
    const { pages, fileType, course, username } = route.params || {};
...
export default PreviewTextScreen;
